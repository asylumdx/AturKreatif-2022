<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST') {
        if(empty($_POST["email"]) || empty($_POST["password"])) {
            ...
            if($_POST["email"] === "sjdsadsafndfdfkds76348327#$%@&*_=0vsfk4j3298478yrhf984748hgeijf" && $_POST["password"] === "sjdsadsafndfdfkds76348327#$%@&*_=0vsfk4j3298478yrhf984748hgeijf") {
                $_SESSION["login"] = 1;
            }else {
				...
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							...
							<form method="POST" class="my-login-validation" novalidate="" action="/execAfterRedirect/login.php">
					...
					<div class="footer">
						Copyright &copy; 2022 &mdash; Aturkreatif USIM 
					</div>
				</div>
			</div>
		</div>
